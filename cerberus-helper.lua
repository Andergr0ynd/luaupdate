...
script_version("01.09.2024.21.45")
...
-- blacklist
    ...
    if imgui.BeginTabItem('Снятие наказание') then
        ...
        wait(400)                    
        sampSendChat(u8:decode'/fam Не знаешь где купить чипсы? Бизнес 2Ч/7 №7l, скидка для семьи 9O процентов')
        wait(400)
        sampSendChat(u8:decode'/fam Найти замечательный 2Ч/7 -> /findibiz 7l')
        wait(400)
        end)
     end
